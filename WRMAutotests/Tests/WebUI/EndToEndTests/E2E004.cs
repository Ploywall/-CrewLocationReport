...
{
    public class E2E004 : BaseWebEndToEndTest
    {
        ...
        {
            WRMAutotests.PageObjects.Web.Contractor.pages.LoginPage loginPage = GetActionsForEndToEndTests().OpenLoginPageForContractor();
